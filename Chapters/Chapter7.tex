...
\decoRule
\caption[Speedup]{Estimated speedup for varying scratchpad sizes and models using the optimal pinning strategy}
\label{fig:speedup}
\end{figure}
...
\decoRule
\caption[Reduction]{Estimated \% of data transfers saved for varying scratchpad sizes and models using the optimal pinning strategy}
\label{fig:Reduction}
\end{figure}
...
\decoRule
\caption[Saved]{Percentage of total DMA transfers incurred versus the minimum achievable DMA transfers incurred by an infinite capacity SPM for each SPM size tested}
\label{fig:Saved}
\end{figure}
