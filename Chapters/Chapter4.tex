...
\lstinputlisting[label={minerva_model_desc}language=Python, caption=Model
description example, basicstyle=\ttfamily\scriptsize]{Figures/minerva_network.py}
...
in figure 5. % TODO FIGURE % For each operator we encounter for each iteration
...
that would be executed by default on SMAUG. Figure 6 %TODO: FIGURE %
