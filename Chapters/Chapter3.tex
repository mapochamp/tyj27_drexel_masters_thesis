...
% Static analysis of all the graphs -> get liveness data -> create initial pin
% mapping of just inputs and outputs with no pinnning -> check all possible spms
% mappings where inputs nad outputs of a given operation are necessary and
% unnegotioable and things that could be pinned will be pinned -> meta info like
% spm size, \# of spms, and tensor size, etc.
